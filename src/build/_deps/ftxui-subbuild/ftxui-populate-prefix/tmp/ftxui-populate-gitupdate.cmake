...
execute_process(
  COMMAND "/usr/sbin/git" --git-dir=.git show-ref "v6.1.9"
  WORKING_DIRECTORY "/home/enzo/Documents/Code/AuTUI/src/build/_deps/ftxui-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/enzo/Documents/Code/AuTUI/src/build/_deps/ftxui-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/enzo/Documents/Code/AuTUI/src/build/_deps/ftxui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
